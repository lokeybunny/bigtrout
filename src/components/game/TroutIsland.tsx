...
export const TroutIsland = () => {
  return (
    <group position={[0, 0, -185]} rotation={[0, Math.PI, 0]}>
      {/* Main body */}
      <mesh position={[0, 2, 0]}>
        <sphereGeometry args={[8, 6, 4]} />
        <meshBasicMaterial color="#2d7a3e" />
      </mesh>
      <mesh position={[0, 2, -8]}>
        <sphereGeometry args={[6, 6, 4]} />
        <meshBasicMaterial color="#2d8a4e" />
      </mesh>
      {/* Head */}
      <mesh position={[0, 2.5, 14]}>
        <sphereGeometry args={[4.5, 6, 4]} />
        <meshBasicMaterial color="#3aaa5e" />
      </mesh>
      {/* Eyes */}
      ...
      <mesh position={[0, 3, -16]} rotation={[0, 0, Math.PI / 4]}>
        ...
        <meshBasicMaterial color="#1a6a2e" />
      </mesh>
      {/* Dorsal fin */}
      <mesh position={[0, 7, 0]}>
        <coneGeometry args={[3, 5, 3]} />
        <meshBasicMaterial color="#1a7a3e" />
      </mesh>
      {/* One palm tree */}
